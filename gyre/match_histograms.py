# From https://github.com/scikit-image/scikit-image/blob/main/skimage/exposure/histogram_matching.py
# Here to avoid making scikit-image a dependancy
# Distributed under the BSD 3-clause license

# Changes:
# - Small tweaks to remove a scikit-image internal include
